import torch
from agents.drtac import DcacInterface
...
class Tm20rtgymDcacInterface(DcacInterface):
    ...
    def replace_act_buf_in_augm_obs_tuple_of_tensors(self, augm_obs_tuple_of_tensors, act_buf_tuple_of_tensors):
        ...
        """
        # print(f"DEV: replace_act_buf_in_augm_obs_tuple_of_tensors: augm_obs_tuple_of_tensors:{augm_obs_tuple_of_tensors}, act_buf_tuple_of_tensors:{act_buf_tuple_of_tensors}")
        ...
        # print(f"DEV: replace_act_buf_in_augm_obs_tuple_of_tensors: mod_augm_obs_uple_of_tensors:{mod_augm_obs_tuple_of_tensors}")
    ...
    def get_act_buf_tuple_of_tensors_from_augm_obs_tuple_of_tensors(self, augm_obs_tuple_of_tensors):
        ...
        Returns:
            act_buf_tuple_of_tensors: (batch, act_buf_len, act_shape) (most recent action at idx 0)
        """
        # print(f"DEV: get_act_buf_tuple_of_tensors_from_augm_obs_tuple_of_tensors: augm_obs_tuple_of_tensors:{augm_obs_tuple_of_tensors}")
        act_buf = tuple(reversed(augm_obs_tuple_of_tensors[-cfg.ACT_BUF_LEN:]))
        # print(f"DEV: get_act_buf_tuple_of_tensors_from_augm_obs_tuple_of_tensors: act_buf:{act_buf}")
        return act_buf
