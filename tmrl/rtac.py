...
from tmrl.nn import no_grad, exponential_moving_average, PopArt
from tmrl.util import partial
from tmrl.rtac_models import ConvRTAC, ConvDouble


@dataclass(eq=0)
class Agent(tmrl.sac.Agent):
    Model: type = tmrl.rtac_models.MlpDouble
