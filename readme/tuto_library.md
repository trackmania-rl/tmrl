...
You can also find a minimal `tmrl` pipeline for non-real-time environments (e.g., Pendulum) [here](https://github.com/trackmania-rl/tmrl/blob/master/tmrl/tuto/tuto_minimal_pendulum_torch.py).
